...
<tr><td>SUM()</td><td>Total salary</td><td>SELECT SUM(salary) FROM employees;</td><td><a href="numeric/aggregate.php">View</a></td></tr>
<tr><td>AVG()</td><td>Average salary</td><td>SELECT AVG(salary) FROM employees;</td><td><a href="numeric/avg.php">View</a></td></tr>
<tr><td>MAX()</td><td>Highest salary</td><td>SELECT MAX(salary) FROM employees;</td><td><a href="numeric/largest.php">View</a></td></tr>
<tr><td>MIN()</td><td>Lowest salary</td><td>SELECT MIN(salary) FROM employees;</td><td><a href="numeric/smallest.php">View</a></td></tr>
